-- Source-verified KICD Grade 7 Creative Arts and Sports addition.
-- Official index: https://kicd.ac.ke/cbc-materials/curriculum-designs/grade-seven-designs/
-- Official Drive file: 13vhFpDNHHufpz__VRZ5lZUkARfIUra7L (Creative Arts and Sports Grade 7, revised design).
-- Additive/idempotent: legacy rows are preserved. Incomplete OCR headings are excluded.
BEGIN;

INSERT INTO curriculum_strands (subject_id, strand_name, strand_description, strand_order)
SELECT s.id, v.strand_name, 'Official KICD Grade 7 Creative Arts and Sports revised-design strand.', v.strand_order
FROM (VALUES
...
SELECT st.id, v.sub_strand_name, 'Official KICD Grade 7 Creative Arts and Sports revised-design content heading.', v.sub_strand_order
FROM (VALUES
 ('Foundations of Creative Arts and Sports','Components',1),
 ('Creating and Performing in Creative Arts and Sports','Drawing and Painting',1),('Creating and Performing in Creative Arts and Sports','Rhythm',2),('Creating and Performing in Creative Arts and Sports','Javelin Sculpture',3),('Creating and Performing in Creative Arts and Sports','Melody',4),('Creating and Performing in Creative Arts and Sports','Handball',5),('Creating and Performing in Creative Arts and Sports','Descant Recorder',6),('Creating and Performing in Creative Arts and Sports','Storytelling Animation',7),('Creating and Performing in Creative Arts and Sports','Football',8),('Creating and Performing in Creative Arts and Sports','Kenyan Folk Songs',9),('Creating and Performing in Creative Arts and Sports','Indigenous Kenyan Craft Beadwork',10),('Creating and Performing in Creative Arts and Sports','Swimming (Optional)',11),('Creating and Performing in Creative Arts and Sports','Kenyan Indigenous Games (Optional)',12)
...
SELECT ss.id, v.topic_name, 'Official KICD Grade 7 Creative Arts and Sports revised-design content anchor.', ARRAY[]::text[], 1
FROM (VALUES
 ('Foundations of Creative Arts and Sports','Components'),
 ('Creating and Performing in Creative Arts and Sports','Drawing and Painting'),('Creating and Performing in Creative Arts and Sports','Rhythm'),('Creating and Performing in Creative Arts and Sports','Javelin Sculpture'),('Creating and Performing in Creative Arts and Sports','Melody'),('Creating and Performing in Creative Arts and Sports','Handball'),('Creating and Performing in Creative Arts and Sports','Descant Recorder'),('Creating and Performing in Creative Arts and Sports','Storytelling Animation'),('Creating and Performing in Creative Arts and Sports','Football'),('Creating and Performing in Creative Arts and Sports','Kenyan Folk Songs'),('Creating and Performing in Creative Arts and Sports','Indigenous Kenyan Craft Beadwork'),('Creating and Performing in Creative Arts and Sports','Swimming (Optional)'),('Creating and Performing in Creative Arts and Sports','Kenyan Indigenous Games (Optional)')
...
WHERE NOT EXISTS (SELECT 1 FROM curriculum_topics t WHERE t.sub_strand_id=ss.id AND lower(trim(t.topic_name))=lower(trim(v.topic_name)) AND t.topic_description ILIKE '%Official KICD Grade 7 Creative Arts%');
COMMIT;
