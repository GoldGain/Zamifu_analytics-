-- Source-verified KICD Grade 4 Creative Arts addition.
-- Official index: https://kicd.ac.ke/cbc-materials/curriculum-designs/grade-four-designs/
-- Official Drive file: 1NhyGe8EsZLgubbxwEvva-sNUPxDHR8r1 (Creative Arts Grade 4).
...
SELECT s.id, v.strand_name, 'Official KICD Grade 4 Creative Arts revised-design strand.', v.strand_order
FROM (VALUES
...
SELECT st.id, v.sub_strand_name, 'Official KICD Grade 4 Creative Arts revised-design sub-strand.', v.sub_strand_order
FROM (VALUES
  ('Creating and Executing','Percussion Musical Instruments (Drawing)',1),('Creating and Executing','Netball',2),('Creating and Executing','Painting and Montage',3),('Creating and Executing','Rhythm',4),('Creating and Executing','Melody',5),
  ('Performing and Displaying','Athletics',1),('Performing and Displaying','Gymnastics',2),('Performing and Displaying','Songs',3),('Performing and Displaying','Photography',4),('Performing and Displaying','Descant Recorder',5),('Performing and Displaying','Swimming',6),('Performing and Displaying','Indigenous Kenyan Games',7),
...
SELECT ss.id, v.sub_strand_name, 'Official KICD Grade 4 Creative Arts revised-design content anchor.', ARRAY[]::text[], 1
FROM (VALUES
  ('Creating and Executing','Percussion Musical Instruments (Drawing)'),('Creating and Executing','Netball'),('Creating and Executing','Painting and Montage'),('Creating and Executing','Rhythm'),('Creating and Executing','Melody'),
  ('Performing and Displaying','Athletics'),('Performing and Displaying','Gymnastics'),('Performing and Displaying','Songs'),('Performing and Displaying','Photography'),('Performing and Displaying','Descant Recorder'),('Performing and Displaying','Swimming'),('Performing and Displaying','Indigenous Kenyan Games'),
...
WHERE NOT EXISTS (
  ...
  WHERE t.sub_strand_id=ss.id
    ...
    AND t.topic_description ~* 'Official KICD Grade 4 Creative Arts'
);
