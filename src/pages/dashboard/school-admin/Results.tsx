    ...
    try {
      ...
      // ── PAGE 1: CLASS SUMMARY ────────────────────────────────────────────────────
      {
        ...
        if (bestPerSubjectList.length > 0) {
          ...
          bestPerSubjectList.slice(0, 10).forEach((b, i) => { const pts = b.points !== null ? ` (${b.points} pts)` : ''; doc.text(`Best in ${b.subjectName}: ${b.percentage}% — ${b.gradeLabel}${pts}`, 20, bestSubjY + 8 + i * 6); });
        }
